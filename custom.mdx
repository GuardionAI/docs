...
Once created, the guardrail is immediately active and evaluates all traffic for the assigned applications. Results appear in the dashboard with a **SAFE / UNSAFE** verdict and confidence score.

<Frame>
  <img src="/images/policies_details.png" alt="Custom guardrail configuration in the Guardion Console" />
</Frame>
