...
<CardGroup cols={2}>
  ...
  <Card title="Guardion-1-8B" icon="brain" href="/guardion-1-8b">
    Multilingual AI safety judge for grounding, hallucination detection, content moderation, and custom criteria evaluation. Fine-tuned from IBM Granite Guardian 3.3 8B.
  </Card>
...
| Custom safety criteria | Guardion-1-8B |
