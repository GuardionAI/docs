...
<AccordionGroup>
  ...
  <Accordion title="API page issues" icon="book-open">
    ...
    <AccordionGroup>
      <Accordion title="All of my OpenAPI pages are completely blank">
        ...
        <Frame>
          !["Convert to OpenAPI 3" menu item highlighted in the Swagger Editor](https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/convert-oas-3.png)
        </Frame>
      </Accordion>
  ...
  <Accordion title="Issues adding SVG to a card" icon="image">
    ...
    ![Output from the SVGR converter with the code inside  and  tags highlighted.](https://mintlify.s3.us-west-1.amazonaws.com/mintlify/images/svg-jsx.png)
